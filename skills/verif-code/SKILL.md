---
name: verif-code
description: Réalise un audit rigoureux de sécurité, robustesse, idempotence, performance mobile et propreté du code avec scoring sur 100.
---
...
### 2. Robustesse, Gestion d'Erreurs & Idempotence (25 points)
...
- **Idempotence systématique :** Protection contre les doubles clics et doubles soumissions, scripts d'initialisation et migrations rejouables sans duplications ni crashs (`IF NOT EXISTS`, clés d'idempotence).
